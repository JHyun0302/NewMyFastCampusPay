package com.newfastcampuspay.money.adapter.in.kafka;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.newfastcampuspay.common.CountDownLatchManager;
import com.newfastcampuspay.common.LoggingProducer;
            ...
            try {
                ...
                while (true) {
                    ...
                    for (ConsumerRecord<String, String> record : records) {
                        ...
                        /**
                         * IncreaseMoneyRequestService.increaseMoneyRequestAsync 의 try-catch -> await() Test
                         * 아래 sleep() 지우면 Async 방식(2번의 Queuing이 동작)이지만 sync 처럼 느낄 수 있다!
                         */
                        try {
                            Thread.sleep(3000);
                        ...
                        //아래 로직이 실행되어야 IncreaseMoneyRequestService의 3.Wait 이후가 실행됨
